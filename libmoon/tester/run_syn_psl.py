...
def plot_psl_figure(solver_name, problem_name, prefs, draw_fig):
...
if __name__ == '__main__':
    ...
    # ['agg_ls', 'agg_tche', 'agg_pbi', 'agg_cosmos', 'epo']
    ...
    plot_psl_figure(solver_name=args.solver_name, problem_name=args.problem_name, prefs=prefs, draw_fig=args.draw_fig)
    plot_psl_loss()
